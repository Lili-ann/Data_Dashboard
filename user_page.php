...
<?php
    ...
    <body class="user-body">
        ...
        <div class="user-container">
            <!-- Header with Conditional Back Button and Logout -->
        ...
        function filterMembers() {
            ...
            cards = document.getElementsByClassName("card"); // Get all member cards
            for (i = 0; i < cards.length; i++) { // Loop through all of the cards
